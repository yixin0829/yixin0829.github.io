  ...
  return (
    <div className="App">
      ...
      <div class="icon-container">
        ...
        <SocialIcon class="icon-item" url="https://open.spotify.com/user/uyavk6iz1mjxx3861u59zqwc0?si=1ffcef5d3fb74132" style={{ height: 25, width: 25 }} target="_blank"/>
        <SocialIcon class="icon-item" url="https://www.instagram.com/yix.tian/?hl=en" style={{ height: 25, width: 25 }} target="_blank"/>
        <SocialIcon class="icon-item" url="https://www.facebook.com/yixin.tian0829" style={{ height: 25, width: 25 }} target="_blank"/>
      </div>

      <p>Hello!</p>
      <p>My name is Yixin /ee'shin/ Tian (田毅鑫). I play with data and create insights.</p>
      ...
      <p>Some of my long-term hobbies include <a href="https://500px.com/p/fredtian0829?view=photos" target="_blank">photography</a>
      ...
      <p>Reach out to me and I'll be more than happy and grateful to chat with you and get to know each other.</p>
