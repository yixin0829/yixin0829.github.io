  ...
  return (
    <div className="App">
      ...
      <div className="icon-container">
        ...
        <SocialIcon className="icon-item" url="https://open.spotify.com/user/uyavk6iz1mjxx3861u59zqwc0?si=1ffcef5d3fb74132" style={{ height: 25, width: 25 }} target="_blank" rel="noreferrer"/>
